...
# ACDS 20.1 720 linux 2021.05.02.19:29:58
...
# ----------------------------------------
# If processador_com_acelerador is one of several IP cores in your
...
TOP_LEVEL_NAME="processador_com_acelerador"
QSYS_SIMDIR="./../"
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/processador_com_acelerador_nios2_gen2_0_cpu_ociram_default_contents.hex ./
  cp -f $QSYS_SIMDIR/submodules/processador_com_acelerador_nios2_gen2_0_cpu_ociram_default_contents.dat ./
  cp -f $QSYS_SIMDIR/submodules/processador_com_acelerador_nios2_gen2_0_cpu_ociram_default_contents.mif ./
  cp -f $QSYS_SIMDIR/submodules/processador_com_acelerador_nios2_gen2_0_cpu_rf_ram_b.hex ./
  cp -f $QSYS_SIMDIR/submodules/processador_com_acelerador_nios2_gen2_0_cpu_rf_ram_b.dat ./
  cp -f $QSYS_SIMDIR/submodules/processador_com_acelerador_nios2_gen2_0_cpu_rf_ram_b.mif ./
  cp -f $QSYS_SIMDIR/submodules/processador_com_acelerador_nios2_gen2_0_cpu_rf_ram_a.hex ./
  cp -f $QSYS_SIMDIR/submodules/processador_com_acelerador_nios2_gen2_0_cpu_rf_ram_a.dat ./
  cp -f $QSYS_SIMDIR/submodules/processador_com_acelerador_nios2_gen2_0_cpu_rf_ram_a.mif ./
  cp -f $QSYS_SIMDIR/submodules/processador_com_acelerador_onchip_memory2_0.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/processador_com_acelerador_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv" -work error_adapter_0                         -cdslib ./cds_libs/error_adapter_0.cds.lib                        
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/processador_com_acelerador_mm_interconnect_0_avalon_st_adapter.vhd"                -work avalon_st_adapter                       -cdslib ./cds_libs/avalon_st_adapter.cds.lib                      
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/processador_com_acelerador_mm_interconnect_0_rsp_mux.sv"                           -work rsp_mux                                 -cdslib ./cds_libs/rsp_mux.cds.lib                                
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/processador_com_acelerador_mm_interconnect_0_rsp_demux.sv"                         -work rsp_demux                               -cdslib ./cds_libs/rsp_demux.cds.lib                              
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/processador_com_acelerador_mm_interconnect_0_cmd_mux.sv"                           -work cmd_mux                                 -cdslib ./cds_libs/cmd_mux.cds.lib                                
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/processador_com_acelerador_mm_interconnect_0_cmd_demux.sv"                         -work cmd_demux                               -cdslib ./cds_libs/cmd_demux.cds.lib                              
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/processador_com_acelerador_mm_interconnect_0_router_002.sv"                        -work router_002                              -cdslib ./cds_libs/router_002.cds.lib                             
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/processador_com_acelerador_mm_interconnect_0_router.sv"                            -work router                                  -cdslib ./cds_libs/router.cds.lib                                 
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/processador_com_acelerador_nios2_gen2_0_cpu.v"                                     -work cpu                                     -cdslib ./cds_libs/cpu.cds.lib                                    
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/processador_com_acelerador_nios2_gen2_0_cpu_debug_slave_wrapper.v"                 -work cpu                                     -cdslib ./cds_libs/cpu.cds.lib                                    
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/processador_com_acelerador_nios2_gen2_0_cpu_debug_slave_sysclk.v"                  -work cpu                                     -cdslib ./cds_libs/cpu.cds.lib                                    
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/processador_com_acelerador_nios2_gen2_0_cpu_debug_slave_tck.v"                     -work cpu                                     -cdslib ./cds_libs/cpu.cds.lib                                    
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/processador_com_acelerador_nios2_gen2_0_cpu_test_bench.v"                          -work cpu                                     -cdslib ./cds_libs/cpu.cds.lib                                    
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/processador_com_acelerador_master_0_p2b_adapter.sv"                                -work p2b_adapter                             -cdslib ./cds_libs/p2b_adapter.cds.lib                            
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/processador_com_acelerador_master_0_b2p_adapter.sv"                                -work b2p_adapter                             -cdslib ./cds_libs/b2p_adapter.cds.lib                            
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/processador_com_acelerador_master_0_timing_adt.sv"                                 -work timing_adt                              -cdslib ./cds_libs/timing_adt.cds.lib                             
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/processador_com_acelerador_irq_mapper.sv"                                          -work irq_mapper                              -cdslib ./cds_libs/irq_mapper.cds.lib                             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/processador_com_acelerador_mm_interconnect_1.v"                                    -work mm_interconnect_1                       -cdslib ./cds_libs/mm_interconnect_1.cds.lib                      
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/processador_com_acelerador_mm_interconnect_0.v"                                    -work mm_interconnect_0                       -cdslib ./cds_libs/mm_interconnect_0.cds.lib                      
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/processador_com_acelerador_onchip_memory2_0.vhd"                                   -work onchip_memory2_0                        -cdslib ./cds_libs/onchip_memory2_0.cds.lib                       
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/processador_com_acelerador_nios2_gen2_0.v"                                         -work nios2_gen2_0                            -cdslib ./cds_libs/nios2_gen2_0.cds.lib                           
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/processador_com_acelerador_master_0.vhd"                                           -work master_0                                -cdslib ./cds_libs/master_0.cds.lib                               
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/processador_com_acelerador.vhd"                                                                                                                                                                               
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/processador_com_acelerador_rst_controller.vhd"                                                                                                                                                                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/processador_com_acelerador_rst_controller_001.vhd"                                                                                                                                                            
fi
