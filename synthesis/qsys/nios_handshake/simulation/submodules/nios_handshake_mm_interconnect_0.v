// nios_handshake_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module nios_handshake_mm_interconnect_0 (
	...
	wire  [13:0] nios2_qsys_0_debug_mem_slave_agent_m0_address;                                      // nios2_qsys_0_debug_mem_slave_agent:m0_address -> nios2_qsys_0_debug_mem_slave_translator:uav_address
	...
	wire  [88:0] nios2_qsys_0_debug_mem_slave_agent_rf_source_data;                                  // nios2_qsys_0_debug_mem_slave_agent:rf_source_data -> nios2_qsys_0_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [88:0] nios2_qsys_0_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios2_qsys_0_debug_mem_slave_agent_rsp_fifo:out_data -> nios2_qsys_0_debug_mem_slave_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> nios2_qsys_0_debug_mem_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // nios2_qsys_0_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [2:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> nios2_qsys_0_debug_mem_slave_agent:cp_channel
	...
	wire  [87:0] nios2_qsys_0_debug_mem_slave_agent_rp_data;                                         // nios2_qsys_0_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	nios_handshake_mm_interconnect_0_router router (
	...
	nios_handshake_mm_interconnect_0_router_001 router_001 (
	...
	nios_handshake_mm_interconnect_0_router_002 router_002 (
	...
	nios_handshake_mm_interconnect_0_router_003 router_003 (
	...
	nios_handshake_mm_interconnect_0_router_003 router_004 (
	...
	nios_handshake_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_handshake_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_handshake_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_handshake_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_handshake_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_handshake_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_handshake_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_handshake_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_handshake_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_handshake_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_handshake_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
