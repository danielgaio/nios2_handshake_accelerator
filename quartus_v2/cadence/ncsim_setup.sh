...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Qsys_handshake/simulation/Qsys_handshake.vhd"                   
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Qsys_handshake/simulation/qsys_handshake_rst_controller.vhd"    
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Qsys_handshake/simulation/qsys_handshake_rst_controller_001.vhd"
fi
