...
# ACDS 16.1 196 win32 2021.05.10.20:22:48
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Qsys_handshake/simulation/Qsys_handshake.vhd"                   
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Qsys_handshake/simulation/qsys_handshake_rst_controller.vhd"    
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Qsys_handshake/simulation/qsys_handshake_rst_controller_001.vhd"
fi
