...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Qsys_handshake/simulation/Qsys_handshake.vhd"                   
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Qsys_handshake/simulation/qsys_handshake_rst_controller.vhd"    
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Qsys_handshake/simulation/qsys_handshake_rst_controller_001.vhd"
}
